...
//    infile="/afs/cern.ch/user/s/szhaozho/public/ForJing/RecoFiles/step2_RAW2DIGI_L1Reco_RECO_Pthat50.root";     
infile="/afs/cern.ch/work/s/szhaozho/D0Private2018/CMSSW_10_0_3/src/Bfinder/test/finder_PbPb.root";
outfile="Pthat50.root";
      REAL=false;
      isPbPb=true;
      skim=false;
      checkMatching=true;
