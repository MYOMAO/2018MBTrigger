...
config.General.requestName = 'LowNOPUPbPbMCAll'
config.General.workArea = 'crab_projects'
config.JobType.psetName = 'finder_PbPb_102X_cfg.py'
...
config.Data.outLFNDirBase ='/store/group/phys_heavyions/zshi/MBTrigger/PbPbMCfinderAll/'
