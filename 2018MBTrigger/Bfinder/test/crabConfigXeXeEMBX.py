...
config.General.requestName = 'XeXeEMBX'
...
config.Data.inputDataset= '/HIEmptyBX/XeXeRun2017-13Dec2017-v1/AOD'
...
config.Data.outLFNDirBase ='/store/group/phys_heavyions/zshi/MBTrigger/XeXeEMBX/'
