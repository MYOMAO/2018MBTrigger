...
void EventMatching()
{
  ...
  TFile *fin1= new TFile("/export/d00/scratch/zzshi/CMSSW_7_5_8_patch3/Merge/MBTrigger/XeXeZB/L1Ntuple_XeXe_2All.root", "READ");
  TFile *fin2= new TFile("/export/d00/scratch/zzshi/CMSSW_7_5_8_patch3/Merge/MBTrigger/finder_XeXe_All.root", "READ");
