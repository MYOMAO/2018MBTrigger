...
void EventMatchingStep(TString inputL1)
{
	gStyle->SetOptFit(0);
	gStyle->SetOptStat(0);
	...
	TFile * fin1 = new TFile(inputL1.Data());

	//TFile * fin1 = new TFile("/eos/cms/store/group/phys_heavyions/zshi/MBTrigger/L1NtupleNewPed/L1NtupleNewPed56.root");
	//	TFile * fin1 = new TFile("/afs/cern.ch/work/s/szhaozho/DataReEmulation/CMSSW_10_1_5/src/L1PbPb2018/MBSamples/L1NtupleNew.root");
	//TFile * fin2 = new TFile("/afs/cern.ch/work/s/szhaozho/DataReEmulation/CMSSW_10_1_5/src/L1PbPb2018/MBSamples/finder_pp_All_New.root");
...
*/
	...
	TFile *fout = new TFile("EventMatched.root","RECREATE");
	fout->cd();
