...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/zshi/MBTrigger/L1NutpleXeXeMB'
config.Site.storageSite = 'T2_CH_CERN'
#config.section_('Data')
config.Data.inputDataset = '/HIMinimumBias9/XeXeRun2017-v1/RAW'
...
config.Data.outputDatasetTag = 'XeXeMB'
