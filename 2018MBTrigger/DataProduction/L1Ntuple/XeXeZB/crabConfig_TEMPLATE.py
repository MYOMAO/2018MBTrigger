...
config.Data.outLFNDirBase = '/store/group/phys_heavyions/zshi/MBTrigger/L1NutpleXeXeZB'
config.Site.storageSite = 'T2_CH_CERN'
#config.section_('Data')
config.Data.inputDataset = '/HIZeroBias/XeXeRun2017-v1/RAW'
...
config.Data.outputDatasetTag = 'XeXeZB'
