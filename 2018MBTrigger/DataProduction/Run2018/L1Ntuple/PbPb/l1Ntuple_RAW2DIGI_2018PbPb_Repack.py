...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:3138AE3E-A8DE-BF48-B65B-2ADA2522994D.root'),
...
process.twinMuxStage2Digis = cms.EDProducer("L1TTwinMuxRawToDigi",
    DTTM7_FED_Source = cms.InputTag("rawDataRepacker"),
...
process.l1ExtraTree = cms.EDAnalyzer("L1ExtraTreeProducer",
    ...
    isoTauJetLabel = cms.untracked.InputTag("l1extraParticles","IsoTau"),
...
process.l1HOTree = cms.EDAnalyzer("L1HOTreeProducer",
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('L1Ntuple2018PbPb.root')
)
...
process.CaloTPGTranscoder = cms.ESProducer("CaloTPGTranscoderULUTs",
    FG_HF_thresholds = cms.vuint32(15, 19),
...
process.L1NtupleEMU = cms.Sequence(process.l1EventTree+process.l1UpgradeTfMuonEmuTree+process.l1CaloTowerEmuTree+process.l1UpgradeEmuTree)
...
process.L1TRawToDigi_Stage2 = cms.Sequence(process.twinMuxStage2Digis+process.bmtfDigis+process.omtfStage2Digis+process.rpcCPPFRawToDigi+process.emtfStage2Digis+process.caloLayer1Digis+process.caloStage2Digis+process.gmtStage2Digis+process.gtStage2Digis)
...
process.SimL1EmulatorCore = cms.Sequence(process.SimL1TCalorimeter+process.SimL1TMuonCommon+process.SimL1TechnicalTriggers+process.SimL1TGlobal)
...
#process.l1ntupleraw = cms.Path(process.L1NtupleRAW)
...
process.schedule = cms.Schedule(*[ process.raw2digi_step, process.endjob_step, process.L1TReEmulPath, process.l1ntupleemu ], tasks=[process.patAlgosToolsTask])
