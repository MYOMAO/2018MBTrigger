...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:64050050-6AAB-E811-9C9C-A0369FE2C1A2.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('l1Ntuple_MC nevts:100'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('L1NtuplePbPbMC.root')
)
...
process.L1NtupleEMU = cms.Sequence(process.l1EventTree)
